        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="login--screen">
                    ...
                    <div class="content">
                        <div class="u-column1 col-1" style="float:none;width: 100%;">
                            <form class="woocommerce-form woocommerce-form-login login" method="post">
                                ...
                                <p class="form-row">
                                    ...
                                    <button type="submit"
                                            class="woocommerce-button button woocommerce-form-login__submit actionButton"
                                            name="login"
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="login--screen">
                    ...
                    <div class="content">
                        ...
                        <div class="u-column2 col-2" style="float:none;width: 100%;">
                            ...
                            <form method="post"
                                ...
                                <p class="woocommerce-form-row form-row">
                                    ...
                                    <button type="submit"
                                            class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit actionButton"
                                            name="register"
